...
description: Create Excalidraw diagram JSON files that make visual arguments and render them to PNG images. Use when the user wants to visualize workflows, architectures, or concepts.
---
...
```bash
cd excalidraw-diagram/scripts && uv run python render_excalidraw.py <path-to-file.excalidraw>
```
